...
//console.log(scores1.sort())    It wont work for integer starts with 0
scores1.sort(function(a,b){     //Method 1
    return a-b
})
console.log(scores1)

console.log(scores1.sort((a,b)=>a-b))     //Method 2   //ascedning
console.log(scores1.sort((a,b)=>b-a))     //Method 2   //desenidng
