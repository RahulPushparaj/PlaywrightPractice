...
test.only('Browser Context Playwright test', async ({browser})=>
{
        ...
        await signIn.click();
        console.log("First Title is : " + await page.locator(".card-body a").first().textContent());
        console.log("Second Title is : " + await page.locator(".card-body a").nth(1).textContent());
